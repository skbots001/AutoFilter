...
API_ID = int(environ.get('API_ID', '21329703'))
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6738911549').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002158569707').split()] #Channel id for auto indexing ( make sure bot is admin )
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002171340177')) #Log channel id ( make sure bot is admin )
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002458778355')) #Notification of those who verify will be sent to your channel. Enter the ID of the channel you want to send notification to here.
PREMIUM_LOGS = int(environ.get('PREMIUM_LOGS', '-1002171340177')) # add premium logs channel id
auth_channel = environ.get('AUTH_CHANNEL', '-1002349913412') #Channel / Group Id for force sub ( make sure bot is admin )
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://autofilterbot:autofilterbot@autofilterbot.egayw.mongodb.net/?retryWrites=true&w=majority&appName=autofilterbot")
...
VERIFIED_LOG = int(environ.get('VERIFIED_LOG', '-1002171340177')) #Log channel id ( make sure bot is admin )
